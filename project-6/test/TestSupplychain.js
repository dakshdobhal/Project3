...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        await supplyChain.harvestItem(upc, originFarmerID, originFarmName, originFarmInformation, originFarmLatitude, originFarmLongitude, productNotes,productID,{from:originFarmerID});
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        assert.equal(resultBufferTwo[4].toNumber(), productPrice, 'Error: Invalid Product Price')
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert.equal(resultBufferTwo[4].toNumber(), productPrice, 'Error: Missing or Invalid productPrice')
        assert.equal(resultBufferTwo[5].toNumber(), 7, 'Error: Missing or Invalid item state') 
